package com.github.thiagomatar.avro.reflection;
...
public class ReflectionExamples {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DataFileWriter<ReflectedCustomer> out = new DataFileWriter<ReflectedCustomer>(writer)
                    .setCodec(CodecFactory.deflateCodec(9))
                    .create(schema, file);

            out.append(new ReflectedCustomer("Thiago", "Matar", "Killer"));
            out.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            File file = new File("customer-reflected.avro");
            DatumReader<ReflectedCustomer> reader = new ReflectDatumReader<ReflectedCustomer>(ReflectedCustomer.class);
            DataFileReader<ReflectedCustomer> in = new DataFileReader<ReflectedCustomer>(file, reader);
